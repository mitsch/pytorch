#ifndef LIBTORCH__TEN__NUMERICAL__HEADER
#define LIBTORCH__TEN__NUMERICAL__HEADER

#include <torch/ten/Logical.hpp>
...
namespace torch::ten
{
    ...
    template <typename N>
    concept bool Numerical = requires(Numerical const& numerical)
    {
        // Algebraic functions:
        ...
        {ArcSine(numerical)} -> Numerical;
        {ArcCosine(numerical)} -> Numerical;
        {ArcTangent(numerical)} -> Numerical;
        {ArcTangent2(numerical)} -> Numerical;

        // Hyperbolic functions
        {SineHyperbolic(numerical)} -> Numerical;
        {CosineHyperbolic(numerical)} -> Numerical;
        {TangentHyperbolic(numerical)} -> Numerical;
        {ArcSineHyperbolic(numerical)} -> Numerical;
        {ArcCosineHyperbolic(numerical)} -> Numerical;
        {ArcTangentHyperbolic(numerical)} -> Numerical;
    };
